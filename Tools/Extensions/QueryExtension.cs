    ...
    public static Uri AddQueries<TParams>(this Uri uri, TParams queryParams)
    {
        ...
        var queries = properties.Select(info =>
        {
            ...
            switch (value)
            {
                ...
                {
                    var elemType = type.IsGenericType ? type.GetGenericArguments()[0] : type.GetElementType();
                    ...
                    else if (elemType.IsEnum)
                    {
                        var elemNames = (from object? e in enumerable
                                         ...
                                         select enumAttr is not null ? enumAttr.Value : enumName).ToList();
                    ...
                    else
                    {
                        throw new ArgumentException(
                            "Generic arguments of enumerables must be primitives, strings or enums.");
                    }
            ...
            if (attribute is null) return info.Name + '=' + valueStr;
