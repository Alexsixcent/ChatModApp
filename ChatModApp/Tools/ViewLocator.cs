...
namespace ChatModApp.Tools
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReactiveUI.DefaultViewLocator"/> class.
        /// </summary>
        /// <param name="viewModelToViewFunc">The method which will convert a ViewModel name into a View.</param>
        internal ViewLocator(Func<string, string>? viewModelToViewFunc = null) => ViewModelToViewFunc = viewModelToViewFunc ?? (vm => vm.Replace("ViewModel", "View"));
