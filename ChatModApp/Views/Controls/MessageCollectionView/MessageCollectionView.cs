...
public sealed partial class MessageCollectionView : Control
{
    ...
    protected override void OnApplyTemplate()
    {
        ...
        if (_scrollViewer is not null) _scrollViewer.ViewChanged -= ScrollViewerOnViewChanged;

        if (_scrollButton is not null) _scrollButton.Click -= ScrollButtonOnClick;
    ...
    private void ScrollButtonOnClick(object sender, RoutedEventArgs e) =>
        ScrollToEnd();
    ...
    private bool IsNearBottom() =>
        IsNearBottom(_scrollViewer!.VerticalOffset);

    private void ScrollToEnd()
    {
        _scrollViewer!.ScrollTo(0d, _scrollViewer.ExtentHeight, new(ScrollingAnimationMode.Disabled));
    }
}
