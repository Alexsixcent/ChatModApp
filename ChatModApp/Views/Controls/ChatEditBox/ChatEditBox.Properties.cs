...
public sealed partial class ChatEditBox
{
    /// <summary>
    ///     Identifies the <see cref="Text"/> dependency property.
    /// </summary>
    public static readonly DependencyProperty TextProperty = DependencyProperty.Register(
     nameof(Text), typeof(string), typeof(ChatEditBox), new(string.Empty));
    ...
    public static readonly DependencyProperty RichEditBoxStyleProperty
        = DependencyProperty.Register(nameof(RichEditBoxStyle),
                                      typeof(Style),
                                      typeof(ChatEditBox),
                                      new(null));
    ...
    public static readonly DependencyProperty PopupPlacementProperty = DependencyProperty.Register(
     ...
     typeof(ChatEditBox),
     new(SuggestionPopupPlacementMode.Floating, OnSuggestionPopupPlacementChanged));
    ...
    public static readonly DependencyProperty PopupCornerRadiusProperty
        = DependencyProperty.Register(nameof(PopupCornerRadius),
                                      typeof(CornerRadius),
                                      typeof(ChatEditBox),
    ...
    public static readonly DependencyProperty PopupHeaderTemplateProperty
        = DependencyProperty.Register(nameof(PopupHeaderTemplate),
                                      typeof(DataTemplate),
                                      typeof(ChatEditBox),
                                      new(null));
    ...
    /// </summary>
    public static readonly DependencyProperty PopupFooterProperty = DependencyProperty.Register(
     nameof(PopupFooter),
     typeof(object),
     typeof(ChatEditBox),
     new(null));
    ...
    public static readonly DependencyProperty PopupFooterTemplateProperty
        = DependencyProperty.Register(nameof(PopupFooterTemplate),
                                      typeof(DataTemplate),
                                      typeof(ChatEditBox),
                                      new(null));
    ...
    public static readonly DependencyProperty TokenBackgroundProperty
        = DependencyProperty.Register(nameof(TokenBackground),
    ...
    public static readonly DependencyProperty TokenForegroundProperty
        = DependencyProperty.Register(nameof(TokenForeground),
                                      typeof(SolidColorBrush),
                                      typeof(ChatEditBox),
                                      new(null));
    ...
    /// </summary>
    public static readonly DependencyProperty PrefixesProperty = DependencyProperty.Register(
     nameof(Prefixes),
     typeof(string),
     typeof(ChatEditBox),
     new(string.Empty, OnPrefixesChanged));
    ...
    public static readonly DependencyProperty ClipboardPasteFormatProperty
        = DependencyProperty.Register(nameof(ClipboardPasteFormat),
                                      typeof(RichEditClipboardFormat),
                                      typeof(ChatEditBox),
                                      new(RichEditClipboardFormat.AllFormats));
    ...
    public static readonly DependencyProperty ClipboardCopyFormatProperty
        = DependencyProperty.Register(nameof(ClipboardCopyFormat),
                                      typeof(RichEditClipboardFormat),
                                      typeof(ChatEditBox),
                                      new(RichEditClipboardFormat.AllFormats));
    ...
    public static readonly DependencyProperty DisabledFormattingAcceleratorsProperty
        = DependencyProperty.Register(nameof(DisabledFormattingAccelerators),
                                      ...
                                      typeof(ChatEditBox),
                                      new(DisabledFormattingAccelerators.None));
    /// <summary>
    ///     Gets or sets the text that is displayed in the control.
    /// </summary>
    public string Text
    {
    ...
    /// <summary>
    ///     Gets or sets content that is shown below the control. The content should provide guidance about the input expected
    ///     by the control.
    /// </summary>
    /// <remarks>
    ///     Suggestion popup relies on the actual size of the text control to calculate its placement on the screen.
    ///     It is recommended to set the description using this property instead of using
    ///     <see cref="RichEditBox.Description" />.
    /// </remarks>
    ...
    /// </summary>
    public ReadOnlyObservableCollection<ChatSuggestToken> Tokens { get; }
}