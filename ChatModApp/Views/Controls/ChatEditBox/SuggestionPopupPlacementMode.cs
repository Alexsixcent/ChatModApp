...
/// <summary>
///     Placement modes for the suggestion popup in <see cref="ChatEditBox" />.
/// </summary>
public enum SuggestionPopupPlacementMode
{
    ...
    /// </summary>
    /// <remarks>
    ///     In this mode, popup width will be text box's width and the interior corners that connect the text box and the popup
    ///     are square.
