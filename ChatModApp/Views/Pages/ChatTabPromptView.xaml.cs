...
public sealed partial class ChatTabPromptView
{
    public ChatTabPromptView()
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.Bind(ViewModel, vm => vm.Channel, v => v.ChannelSuggestBox.Text).DisposeWith(disposables);

            ChannelSuggestBox.Events().QuerySubmitted
                             .Select(tuple => tuple.args.ChosenSuggestion as ChannelSuggestionViewModel).WhereNotNull()
