...
public static class ObjectEx
{
    private static readonly MethodInfo CloneMethod =
        typeof(object).GetMethod("MemberwiseClone", BindingFlags.NonPublic | BindingFlags.Instance) ?? throw new PlatformNotSupportedException();

    public static bool IsPrimitive(this Type type)
    {
        if (type == typeof(string)) return true;
        if (type == typeof(Type)) return true; //Deep copy or type instances prevents correct value comparisons of types
